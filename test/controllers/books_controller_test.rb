...
class BooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book" do
    assert_difference('Book.count') do
      post books_url, params: { book: { author_id: @book.author_id, genre_id: @book.genre_id, internal_number: @book.internal_number, is_borrowed: @book.is_borrowed, title: @book.title } }
    end
